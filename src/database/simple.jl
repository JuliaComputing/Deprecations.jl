...
const renames = [
    ...
    @add_rename LinAlg         LinearAlgebra    v"0.7.0-alpha"
    @add_rename bits           bitstring        v"0.7.0-alpha"
    @add_rename search         findfirst        v"0.7.0-alpha"
    @add_rename rsearch        findlast         v"0.7.0-alpha"
    ...
    @add_rename Date()        Date(1)           v"0.7.0-alpha"
    @add_rename Time()        Time(1)           v"0.7.0-alpha"
    @add_rename isupper       isuppercase       v"0.7.0-alpha"
    @add_rename islower       islowercase       v"0.7.0-alpha"
    @add_rename ucfirst       uppercasefirst    v"0.7.0-alpha"
    @add_rename lcfirst       lowercasefirst    v"0.7.0-alpha"
    @add_rename Base.IntSet   Base.BitSet       v"0.7.0-alpha"
    ...
    @add_rename GMP.GMP_VERSION GMP.VERSION     v"0.7.0-alpha"
    @add_rename GMP.gmp_bits_per_limb GMP.bits_per_limb v"0.7.0-alpha"
    @add_rename GMP.GMP_BITS_PER_LIMB GMP.version v"0.7.0-alpha"
    @add_rename MPFR.get_version MPFR.version   v"0.7.0-alpha"
    @add_rename LinAlg.LAPACK.laver LinearAlgebra.LAPACK.version v"0.7.0-alpha"
]
